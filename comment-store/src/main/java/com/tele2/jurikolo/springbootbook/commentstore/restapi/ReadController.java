package com.tele2.jurikolo.springbootbook.commentstore.restapi;
...
import com.tele2.jurikolo.springbootbook.commentstore.service.CommentService;
...
public class ReadController {
    ...
    public List<CommentDTO> getComments(@PathVariable(value = "id") String pageId) throws IOException {
        ...
        meterRegistry.counter("commentstore.list_comments");
